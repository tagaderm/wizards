...
void AWizardsCharacter::ServerFireProjectile_Implementation(bool bNewSomeBool){
	UWorld* const World = GetWorld();
...
bool AWizardsCharacter::ServerFireProjectile_Validate(bool bNewSomeBool){
	return true;
}
