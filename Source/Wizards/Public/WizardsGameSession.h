...
struct FWizardsGameSessionParams
{
...
protected:
	...
	FWizardsGameSessionParams CurrentSessionParams;
	/** Current host settings */
	TSharedPtr<class OnlineSessionSettings> HostSettings;
	/** Current search settings */
	//TSharedPtr<class FWizardsOnlineSearchSettings> SearchSettings;
	...
	*/
	DECLARE_EVENT_TwoParams(AWizardsGameSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
	...
	*/
	...
	DECLARE_EVENT_OneParam(AWizardsGameSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
	FOnJoinSessionComplete JoinSessionCompleteEvent;

	/*
	* Event triggered after session search completes
	*/
	//DECLARE_EVENT(AWizardsGameSession, FOnFindSessionsComplete);
	DECLARE_EVENT_OneParam(AWizardsGameSession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
