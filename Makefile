...
Wizards-Linux-Debug:
	 $(PROJECTBUILD) Wizards Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

Wizards-Linux-DebugGame:
	 $(PROJECTBUILD) Wizards Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

Wizards-Linux-Shipping:
	 $(PROJECTBUILD) Wizards Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

Wizards-Linux-Test:
	 $(PROJECTBUILD) Wizards Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

Wizards:
	 $(PROJECTBUILD) Wizards Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

WizardsEditor-Linux-Debug:
	 $(PROJECTBUILD) WizardsEditor Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

WizardsEditor-Linux-DebugGame:
	 $(PROJECTBUILD) WizardsEditor Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

WizardsEditor-Linux-Shipping:
	 $(PROJECTBUILD) WizardsEditor Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

WizardsEditor-Linux-Test:
	 $(PROJECTBUILD) WizardsEditor Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

WizardsEditor:
	 $(PROJECTBUILD) WizardsEditor Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)
