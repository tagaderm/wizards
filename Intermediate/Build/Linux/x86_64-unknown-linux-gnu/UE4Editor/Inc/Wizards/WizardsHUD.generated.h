...
#define wizards_Source_Wizards_WizardsHUD_h_11_INCLASS_NO_PURE_DECLS \
	...
	public: \
	DECLARE_CLASS(AWizardsHUD, AHUD, COMPILED_IN_FLAGS(0 | CLASS_Transient | CLASS_Config), 0, Wizards, NO_API) \
	DECLARE_SERIALIZER(AWizardsHUD) \
	/** Indicates whether the class is compiled into the engine */    enum {IsIntrinsic=COMPILED_IN_INTRINSIC}; \
	virtual UObject* _getUObject() const override { return const_cast<AWizardsHUD*>(this); }
